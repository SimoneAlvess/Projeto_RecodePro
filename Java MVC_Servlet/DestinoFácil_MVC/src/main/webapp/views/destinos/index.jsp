                ...
                <td>
                  <div class="d-flex">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="./destino-update">
                              ...
                              <div class="form-floating mt-4 mb-3 mx-3">
                                <input class="form-control" type="number" step="0.01" id="preco" name="preco" value="${destino.preco}" placeholder="#">
                                <label for="preco">Preço</label>
                              </div>
                    ...
                    <a href="destino-delete?id=${destino.idDestino}" class="mx-1" title="Excluir"
                      onclick="return confirm('Deseja excluir o destino ${destino.destino}?')"> <i class="bi bi-x-octagon-fill iconDelete fs-4"></i>
                    </a>
                  </div>
                </td>
              </tr>
