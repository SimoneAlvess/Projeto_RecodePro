                  ...
                  <div class="mb-4 mx-3">
                    ...
                    <select class="form-select py-3" id="destino" name="destino">
                      ...
                      <jstl:forEach items="${listaDestinos}" var="destino">
                        <option value="${destino.idDestino}">${destino.destino} - R$ <fmt:formatNumber value="${destino.precoTotal}" type="number" minFractionDigits="2"/></option>
                      </jstl:forEach>
                    </select>
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <div class="modal fade" id="compraModalEdit-${compra.idCompra}" tabindex="-1" aria-labelledby="modalLabelEdit" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header bgForms position-relative">
